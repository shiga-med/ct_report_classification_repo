...
- **Detailed Usage**: See [docs/USAGE.md](USAGE.md)
- **Experimental Details**: See [docs/EXPERIMENTS.md](EXPERIMENTS.md)
...
2. 📖 Read [USAGE.md](USAGE.md) for detailed instructions
3. 🔬 Read [EXPERIMENTS.md](EXPERIMENTS.md) for methodology
